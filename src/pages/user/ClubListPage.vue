<template>
  <div class="table">
    ...
    <el-table size="mini" ref="multipleTable" style="width:100%" height="480px" :data="tableData"
      ...
      <el-table-column prop="userName" label="社长" width="180" align="center"></el-table-column>
...
<script>
import {getClubList, addClub, updateClub, deleteNotice, stopClub, updateClubUser, getClubUserList, deleteClubUser, addClubUser} from '../../api';
