<template>
  <div class="table">
      ...
      <div class="handle-box">
        <el-form :inline="true" :model="queryForm" class="demo-form-inline">
          ...
          <el-form-item>
            ...
            <!-- <el-button type="success" @click="addClubBtn()">添加新社团</el-button> -->
          </el-form-item>
        </el-form>
      </div>
    </div>
    <el-table size="mini" ref="multipleTable" style="width:100%" height="480px" :data="tableData"
      ...
      <el-table-column prop="name" label="社团名称" width="220"></el-table-column>
      <el-table-column prop="content" label="社团简介"></el-table-column>
      <el-table-column prop="crtTime" label="加入时间" width="150" align="center"></el-table-column>
      <el-table-column label="角色" width="120" align="center">
        <template slot-scope="scope">
          <el-tag
            v-if="scope.row.leader === '1'"
            :type="scope.row.leader === '1' ? 'success' : 'success'"
            disable-transitions>社长
          </el-tag>
          <el-tag
             v-if="scope.row.leader === '0'"
            :type="scope.row.leader === '0' ? 'primary' : 'primary'"
            disable-transitions>会员
          </el-tag>
        </template>
      </el-table-column>
       <el-table-column label="审批情况" width="120" align="center">
        <template slot-scope="scope">
          <el-tag
            v-if="scope.row.pass === '0'"
            :type="scope.row.pass === '0' ? 'danger' : 'danger'"
            disable-transitions>拒绝
          </el-tag>
          <el-tag
      ...
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="scope">
          <!-- <el-button size="mini" type="success" @click="userAddClubBtn(scope.row)" v-if="scope.row.flag === null">申请加入</el-button> -->
          <!-- <el-button size="mini" type="success" @click="getClubUserListBtn(scope.row)">会员</el-button> -->
          <!-- <el-button size="mini" type="waring" @click="updateClubUserBtn(scope.row)">设置社长</el-button> -->
          <!-- <el-button size="mini" type="primary" @click="handleEdit(scope.row)">编辑</el-button> -->
          <el-button size="mini" type="danger" @click="handleDelete(scope.row.id)">退出</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="添加新社团" :visible.sync="centerDialogVisible" width="600px" center>
      <el-form :model="addForm" ref="addForm" label-width="80px" :rules="rules">
        <el-form-item prop="name" label="社团名称" size="mini">
          <el-input v-model="addForm.name" placeholder="标题"></el-input>
        </el-form-item>
        <el-form-item label="社团简介" size="mini">
    ...
    <el-dialog title="修改社团" :visible.sync="editVisible" width="600px" center>
    ...
    <el-dialog title="会员列表" :visible.sync="clubListVisible" width="1000px" center>
      <div class="handle-box">
...
<script>
import {getMyClubList, addClub, updateClub, deleteNotice, stopClub, updateClubUser, getClubUserList, deleteClubUser, addClubUser} from '../../api';
